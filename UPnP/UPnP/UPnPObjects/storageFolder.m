...
{
    NSMutableString *myAttributes = [NSMutableString stringWithFormat:@"<upnp:storageUsed>%qu</upnp:storageUsed>", self.storageUsed]; 
    [myAttributes appendString:@"<upnp:writeStatus>PROTECTED</upnp:writeStatus>"];
    [myAttributes appendFormat:@"<upnp:storageUsed>%@</upnp:storageUsed>", self.storageUsed];
...
- (void)populateChildren
{
    ...
    {
        NSString *fullPath = [self.relativePath stringByAppendingString:file];
